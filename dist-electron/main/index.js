import require$$1$2, { app as app$1, BrowserWindow, Menu, ipcMain as ipcMain$1 } from "electron";
...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    icon: require$$0$1.join(__dirname$1, "../../build/icon.png"),
    webPreferences: {
      preload: require$$0$1.join(__dirname$1, "../preload/index.js"),
      ...
      submenu: [
        {
          ...
          click: () => {
            mainWindow == null ? void 0 : mainWindow.webContents.send("menu:new-game");
          }
        },
        {
          label: "保存",
          ...
          click: () => {
            mainWindow == null ? void 0 : mainWindow.webContents.send("menu:save");
          }
        },
        {
          label: "加载",
          ...
          click: () => {
            mainWindow == null ? void 0 : mainWindow.webContents.send("menu:load");
          }
        },
        { type: "separator" },
        {
...
function setupIPC() {
  ipcMain$1.handle("save-game", (_, data) => {
    try {
      store.set("save", data);
      return { success: true };
    } catch (error2) {
